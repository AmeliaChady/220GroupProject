...
private:
    ...
    LinkedList<T>& operator=(const LinkedList<T>& arrayListToCopy);
    /**
    ...
    */
    void emptyTest();
    /**
    * Tests errors for the index given
    * @param index: The index to test
    * @param allowNumItems: if index can equal the number of items
    * @throws std::out_of_range exception if the index is not valid
    */
    void indexTest(int index, bool allowNumItems);
public:
    /**
     * Constructor
     */
    ...
    /**
     * removes the item at the end ofr the list, and returns a copy of that item
     ...
     * @return a copy of the item at index
     * @throws out_of_ange exception if index is invalid
     */
